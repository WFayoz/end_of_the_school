    ...
    <div className="max-w-[1350px] w-full mx-auto px-5">
      ...
      <div className="grid grid-cols-2 gap-3">
        {servicesData.map((item) => (
          <div key={item.id} className="flex bg-primaryWhite rounded-xl justify-between overflow-hidden ">
            ...
            <img src={item.img} alt={item.name} className="w-[265px] object-cover bg-transparent"/>
          </div>
        ))}
      </div>
    </div>
