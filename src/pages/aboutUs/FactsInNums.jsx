...
const FactsInNums = () => {
  return (
    <div className="mx-auto mt-36 flex w-full max-w-[1350px] justify-between px-5">
      <div className="w-[48%]">
      ...
      <div className="w-[48%]">
        <div className="flex items-center border-b border-accent py-5">
          ...
          <p className="pl-40 text-primaryBlack">на рынке</p>
        </div>
        <div className="flex items-center border-b border-accent py-5">
          <h2 className="w-[138px] text-[48px] text-primaryGreen">964+</h2>
          <p className="pl-40 text-primaryBlack">
        ...
        <div className="flex items-center py-5">
          ...
          <p className="pl-40 text-primaryBlack">товаров всегда в наличии</p>
        </div>
      </div>
    </div>
  );
