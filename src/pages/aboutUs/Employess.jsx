...
const Employess = () => {
  return (
    <div className="mx-auto w-full max-w-[1350px] px-5 py-16">
      <div className="flex w-[48%] flex-col items-start justify-center max-md:w-full">
        <h2 className="text-[30px] text-primaryBlack">
          Опытные сотрудники из <br />
          производственных компаний
        </h2>
        <p className="w-[540px] pt-6 text-primaryBlack max-md:w-full">
