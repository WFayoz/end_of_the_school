...
const CatagorySection = () => {
  return (
    <div className="mx-auto mt-36 max-w-[1350px] items-center justify-center overflow-hidden px-5">
      ...
      <div className="mt-[45px] grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <Link to={"/catalog"}>
            <div className="flex-1 rounded-lg border border-accent bg-primaryCream">
              <img
                ...
                alt="img"
                className="h-[220px] w-full rounded-t-lg bg-primaryWhite object-contain"
              />
              <p className="p-5 text-primaryBlack">
        ...
        >
          <Link to={"/catalog"} className="h-full">
            <img
              src="https://global-mt.ru/upload/iblock/85e/o3f2bd3fcsty3x0ykxn00ki55gjdkb3r/metrologya7.jpg"
              alt="img"
              className="h-[540px] w-full rounded-t-lg bg-primaryWhite object-contain"
            />
            <p className="p-5 text-primaryBlack">
        ...
        <div className="flex flex-col gap-3">
          <Link to={"/catalog"}>
            <div className="flex-1 rounded-lg border border-accent bg-primaryCream">
              <img
                src="https://global-mt.ru/upload/iblock/d9a/znevgk80fmxnma6s5mid0zvb75leyal0/testery_germetichnosti.webp"
                alt="img"
                className="h-[220px] w-full rounded-t-lg bg-primaryWhite object-contain"
              />
              <p className="p-5 text-primaryBlack">
          ...
          <Link to={"/catalog"}>
            <div className="flex-1 rounded-lg border border-accent bg-primaryCream">
              <img
                src="https://global-mt.ru/upload/iblock/653/ckz3b0q869x4wl2iv444lmwtbc54a11a/pompy_irrigacionnye.webp"
                alt="img"
                className="h-[220px] w-full rounded-t-lg bg-primaryWhite object-contain"
              />
              <p className="p-5 text-primaryBlack">
